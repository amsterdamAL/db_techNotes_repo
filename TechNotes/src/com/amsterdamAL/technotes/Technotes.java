...
public class Technotes extends Activity implements OnItemSelectedListener {
	...
	public final static String DATE = "com.amsterdamAL.technotes.MESSAGE1";
	public final static String NAME = "com.amsterdamAL.technotes.MESSAGE2";
	public final static String ADDRESS = "com.amsterdamAL.technotes.MESSAGE3";
	public final static String APT = "com.amsterdamAL.technotes.MESSAGE33";
	public final static String JOB_ID = "com.amsterdamAL.technotes.MESSAGE4";
	public final static String SPIN_TN = "com.amsterdamAL.technotes.MESSAGE66";
	public final static String TN = "com.amsterdamAL.technotes.MESSAGE5";
	public final static String SPIN_CBR = "com.amsterdamAL.technotes.MESSAGE66";
	public final static String CBR = "com.amsterdamAL.technotes.MESSAGE6";
	public final static String F1 = "com.amsterdamAL.technotes.MESSAGE7";
	public final static String F2 = "com.amsterdamAL.technotes.MESSAGE11";
	public final static String F3 = "com.amsterdamAL.technotes.MESSAGE15";
	public final static String F4 = "com.amsterdamAL.technotes.MESSAGE77";
	public final static String XBX = "com.amsterdamAL.technotes.MESSAGE19";
	public final static String F2TERM = "com.amsterdamAL.technotes.MESSAGE20";
	public final static String RT = "com.amsterdamAL.technotes.MESSAGE21";
	public final static String MEMO = "com.amsterdamAL.technotes.MESSAGE22";
	...
	// Spinners and their string values
	...
	//ADDUSER button gets strings for db and to display in facility.class
...
// If address is empty, do nothing but toast.
if (stringAddy != null && !stringAddy.isEmpty()) {
		...
		if (spinnerF1Str.equals("Ca") || spinnerF1Str.equals("PG")
			...
			sbF1.append(spinnerF1Str+" "+f1Cable+", "+f1Pair+" / "+f1Bp);
		...
		// send to db
		long id = techhelper.insertData(stringFullDate,jobId,name,stringFullAddress,
							apt,stringFullTn,stringFullCbr,stringFullF1,stringFullF2,
							stringFullF3,stringFullF4,stringFullXbx,stringFullF2Term,
							stringFullRt,memo);
			
		// check if id returns positive number
		if (id < 0) {
		...
		bundle.putString(DATE, stringFullDate);
		bundle.putString(JOB_ID, jobId);
		bundle.putString(NAME, name);
		bundle.putString(ADDRESS, stringFullAddress);
		bundle.putString(APT, apt);
		bundle.putString(SPIN_TN, spinnerTnStr);
		bundle.putString(TN, trblTn);
		bundle.putString(SPIN_CBR, spinnerCbrStr);
		bundle.putString(CBR, cbr);
		bundle.putString(F1, stringFullF1);
		bundle.putString(F2, stringFullF2);
		bundle.putString(F3, stringFullF3);
		bundle.putString(F4, stringFullF4);
		bundle.putString(F2TERM, stringFullF2Term);
		bundle.putString(RT, stringFullRt);
		...
		startActivity(i);
			...
			Message.message(this, "need more info...");
		}
	}

	
	
	// Button shows current SQlite database in toast
